...
async def process_bot_message(message: str, phone: str, db: AsyncSession) -> str:
    """
    ...
    if order_match:
        ...
        if not repair:
            return f"❌ La orden *{order_number}* no fue encontrada en nuestro sistema. Por favor verifica el número e intenta nuevamente."
    ...
    return (
        ...
        "Escribe *menu* para ver las opciones disponibles o introduce una orden y verificación válida (ej: `ORD-00042 12345678`)."
    )
